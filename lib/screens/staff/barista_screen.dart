...
class _BaristaScreenState extends State<BaristaScreen> {
                    ...
                    Row(
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: TextButton(
                            style: TextButton.styleFrom(
                              backgroundColor: EmarColors.paprikaDim.withValues(
                                alpha: 0.15,
                              ),
  ...
  Widget build(BuildContext context) {
    ...
    final int completedToday = app.orders.activeBaristaOrders.where((o) {
      ...
      final d = o
          .createdAt; // completed_at modeli frontend'de yoksa createdAt veya updated_at kullanırız.
                ...
                child: Row(
                  ...
                  children: [
                    _column(
                      ...
                      app.orders.activeBaristaOrders,
                      app,
                    ),
                    _column(
                      'Hazırlanıyor',
