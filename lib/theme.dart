...
class EmarColors {
  ...
  static ThemeData dark() {
    const scheme = ColorScheme(
      ...
      onSurface: EmarColors.oat,
      surfaceContainerHighest: Color(0xFF2C3942),
    ...
    return ThemeData(
      useMaterial3: true,
      colorScheme: scheme,
      scaffoldBackgroundColor: const Color(0xFF131A1E),
      ...
      appBarTheme: const AppBarTheme(
        backgroundColor: Color(0xFF131A1E),
        foregroundColor: EmarColors.oat,
        elevation: 0,
        centerTitle: false,
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        labelStyle: TextStyle(color: EmarColors.oat.withValues(alpha: 0.6)),
        hintStyle: TextStyle(color: EmarColors.oat.withValues(alpha: 0.4)),
      ),
      snackBarTheme: SnackBarThemeData(
        backgroundColor: const Color(0xFF2C3942),
        contentTextStyle: const TextStyle(color: EmarColors.oat, fontWeight: FontWeight.w600),
